<x-guest-layout title="Register">
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select id="role" class="block mt-1 w-full" name="role" required autocomplete="role">
        ...
        <div class="mt-4">
            ...
            <select id="status" class="block mt-1 w-full" name="status" required autocomplete="status">
