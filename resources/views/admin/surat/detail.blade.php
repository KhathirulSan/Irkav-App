<x-app-layout title="Admin Dashboard | Detail Dokumen ">
    <x-slot name="header">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.surat') }}" class="btn btn-warning mb-3">Kembali</a>
                                <div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Dokumen Surat</h4>
                                        <a href="{{ route('admin/surat/downloadPdf', $mails->File) }}"
